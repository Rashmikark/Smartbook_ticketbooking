"""
Django Management Command - Bulk Seed Events, Venues & Shows
Save this file to: backend/events/management/commands/seed_events.py
...
STATES_DATA = [
    ...
    {
        "state": "Haryana",
        "cities": ["Gurugram", "Faridabad", "Hisar"],
...
# Show dates - spread across next 30 days
def get_show_dates():
    today = date.today()
...
class Command(BaseCommand):
    help = "Bulk seed Events, Venues and Shows for all 28 states"

    def handle(self, *args, **kwargs):
        self.stdout.write(self.style.WARNING("🚀 Starting bulk seed..."))
        ...
        for state_data in STATES_DATA:
            ...
            # Build list of (title, category_key) tuples
            all_events = []
            ...
            for city in cities:
                for title, cat_key in all_events:
                    ...
                    # Create Shows (3 shows across different dates & times)
                    for i in range(3):
        ...
        self.stdout.write(self.style.SUCCESS(
            ...
            f"   🏛️  Venues created  : {total_venues}\n"
            f"   🎟️  Shows created   : {total_shows}\n"
        ))